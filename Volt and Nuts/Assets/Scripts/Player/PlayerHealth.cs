...
{
    public Sprite[] heartSprites;  // Unity Inspector에서 드래그 앤 드롭으로 설정
    ...
    private void TakeDamage(int damageAmount)
    {
        ...
        CurrentHealth -= damageAmount;
        StartCoroutine(DamageRecoveryRoutine()); // 다시 데미지 받기까지의 시간

        UpdateHeartImage();
        CheckIfPlayerDeath();
    }

    private IEnumerator DamageRecoveryRoutine() // 다시 데미지 받기까지 코루틴
    {
